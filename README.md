...
It works for every version from 1.14 to the newest although some crafting recipes will not appear/work as they need items that in older versions don't exist.
